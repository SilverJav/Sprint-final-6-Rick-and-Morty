<template>
  ...
  <div class="container-fluid mb-5">
    ...
    <div class="d-flex justify-content-end">
        <button class="btn btn-primary" href="" data-bs-toggle="modal" data-bs-target="#exampleModalCart">Ver Carrito</button>
    </div>
        ...
        <div class="card">
          ...
          <div class="d-flex justify-content-center flex-wrap">
            <div class="d-flex justify-content-around w-100">
              <button v-if="item.stock > 0" type="button" class="btn btn-primary p-1" @click="addToCart(item.id)">Comprar</button>
              <button v-else type="button" class="btn btn-primary p-1 disabled" @click="addToCart(item.id)">Comprar</button>
              <button
                type="button"
